    ...
    <div class="main-menu material-menu menu-fixed menu-light menu-accordion    menu-shadow " data-scroll-to-active="true">
        ...
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                <li class="active"><a href="index.html"><i class="material-icons">settings_input_svideo</i><span class="menu-title" data-i18n="Dashboard Hospital">Dashboard Hospital</span></a>
                </li>
                <li class=" navigation-header"><span data-i18n="Professional">Professional</span><i class="material-icons nav-menu-icon" data-toggle="tooltip" data-placement="right" data-original-title="Professional">more_horiz</i>
                </li>
                <li class=" nav-item"><a href="#"><i class="material-icons">event</i><span class="menu-title" data-i18n="Appointment">Appointment</span></a>
                    <ul class="menu-content">
                        <li><a class="menu-item" href="hospital-doctor-schedule.html"><i class="material-icons"></i><span>Doctor Schedule</span></a>
                        </li>
                        <li><a class="menu-item" href="hospital-book-appointment.html"><i class="material-icons"></i><span>Book Appointment</span></a>
                        </li>
                    </ul>
                </li>
                <li class=" nav-item"><a href="#"><i class="material-icons">control_point</i><span class="menu-title" data-i18n="Doctors">Doctors</span></a>
                    <ul class="menu-content">
                        <li><a class="menu-item" href="hospital-doctors-list.html"><i class="material-icons"></i><span>All Doctors</span></a>
                        </li>
                        <li><a class="menu-item" href="hospital-add-doctor.html"><i class="material-icons"></i><span>Add Doctors</span></a>
                        </li>
                        <li><a class="menu-item" href="hospital-doctor-profile.html"><i class="material-icons"></i><span>Doctor Profile</span></a>
                        </li>
                    </ul>
                </li>
                <li class=" nav-item"><a href="#"><i class="material-icons">people_outline</i><span class="menu-title" data-i18n="Patients">Patients</span></a>
                    <ul class="menu-content">
                        <li><a class="menu-item" href="hospital-patients-list.html"><i class="material-icons"></i><span>All Patients</span></a>
                        </li>
                        <li><a class="menu-item" href="hospital-add-patient.html"><i class="material-icons"></i><span>Add Patients</span></a>
                        </li>
                        <li><a class="menu-item" href="hospital-patient-profile.html"><i class="material-icons"></i><span>Patient Profile</span></a>
                        </li>
                    </ul>
                </li>
                <li class=" nav-item"><a href="hospital-payment-reports.html"><i class="material-icons">playlist_add_check</i><span class="menu-title" data-i18n="Report">Report</span></a>
                </li>
                <li class=" nav-item"><a href="#"><i class="material-icons">attach_money</i><span class="menu-title" data-i18n="Payments">Payments</span></a>
                    <ul class="menu-content">
                        <li><a class="menu-item" href="hospital-payments.html"><i class="material-icons"></i><span>Payments</span></a>
                        </li>
                        <li><a class="menu-item" href="hospital-add-payments.html"><i class="material-icons"></i><span>Add Payments</span></a>
                        </li>
                    </ul>
                </li>
